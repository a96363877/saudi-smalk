                  ...
                  <div className="AddressForm_form__i7dus">
                    ...
                    <div className="Textarea_input__j1c7L">
                      ...
                      <textarea
                        ...
                        placeholder="Add delivery instructions for driver"
                ...
                <div className="OrderInfo_wrapper__GCgIK">
                  <div className="OrderSubCartInfo_cart__81olU">
                    ...
                    <div className="OrderSubCartInfo_item__D9NAh">
                      ...
                      <p className="Typography_p6__xuxGw">0 SAR</p>
                    </div>
                  </div>
                </div>
                <div
                    ...
                    <label className="radio" htmlFor="payFull1">
                      ...
                      >
                        ...
                        <p
                          ...
                          style={{ fontSize: 13 }}
                        >
                          Pay the total order amount now using your card and get free delivery
                        </p>
                      </div>
                    </label>
                  </div>
                  ...
                  >
                    ...
                    <label className="radio" htmlFor="payFull2">
                      ...
                      >
                        ...
                        >
                          Pay 10 SAR only to confirm your order
                        </p>
                        <p
                          className="Typography_p6__xuxGw CardAddress_address__tGiBR"
                          style={{ fontSize: 13 }}
                        >
                          Deducted from order value and pay the rest on delivery with a delivery fee of 10 SAR
                        </p>
                      </div>
                    </label>
                  </div>
              ...
              <div className="MarketplaceCardPayment_stickyBottomContent__irsnG">
                ...
                >
                  <span className="Button_content">
                    Continue to Payment
                    <p>( {isCheked === 'payfull' ? total : 10} SAR)</p>
                  </span>
                </button>
              </div>
              <div />
